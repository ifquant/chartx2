...
- `LegendViewModel`
  ...
  - workbench now restores `Line Break` lower panes as chart-context synthetic volume/study series; the remaining gap is engine-level synthetic-study parity beyond the demo path
