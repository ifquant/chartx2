  ...
  const run18Trades = [
    {
      ...
      side: "long" as const,
      symbolLabel: symbol,
      entryTimeLabel: "Apr 25 09:40",
      exitTimeLabel: "Apr 25 12:05",
      entryPriceLabel: "18,510.5",
      exitPriceLabel: "18,622.0",
      quantityLabel: "1 lot",
      durationLabel: "145m",
      pnlLabel: "+1,115",
      statusLabel: "Closed into trend extension",
    },
    {
      id: "trade-18-2",
      side: "short" as const,
      symbolLabel: symbol,
      entryTimeLabel: "Apr 26 10:15",
      exitTimeLabel: "Apr 26 11:25",
      entryPriceLabel: "18,640.0",
      exitPriceLabel: "18,671.5",
      quantityLabel: "1 lot",
      durationLabel: "70m",
      pnlLabel: "-315",
      statusLabel: "Stopped on squeeze",
    },
    {
      id: "trade-18-3",
      side: "long" as const,
      symbolLabel: symbol,
      entryTimeLabel: "Apr 28 13:05",
      exitTimeLabel: "Apr 28 14:55",
      entryPriceLabel: "18,702.0",
      exitPriceLabel: "18,798.0",
      quantityLabel: "2 lots",
      durationLabel: "110m",
      pnlLabel: "+1,920",
      statusLabel: "Closed at measured move",
    },
  ];
  return {
    ...
    runOptions: [
      {
        ...
        tradeDetails: [
          {
            tradeId: "trade-1",
            title: `${symbol} long breakout`,
            subtitle: "Breakout continuation",
            statusLabel: "Closed at target",
            fields: [
              { id: "entry", label: "Entry", valueLabel: "Apr 18 09:35 · 18,412.0" },
              { id: "exit", label: "Exit", valueLabel: "Apr 18 11:10 · 18,505.5" },
              { id: "qty", label: "Size", valueLabel: "2 lots · 95m" },
              { id: "pnl", label: "Net P&L", valueLabel: "+1,870" },
              { id: "source", label: "Source chart", valueLabel: "workbench-main" },
            ],
            locateLabel: "Locate on chart",
            locateIntent: {
              kind: "locate-trade",
              tradeId: "trade-1",
              symbol,
              entryTime: Date.UTC(2026, 3, 18, 9, 35),
              exitTime: Date.UTC(2026, 3, 18, 11, 10),
              entryPrice: 18412,
              exitPrice: 18505.5,
              side: "long",
              quantity: 2,
              realizedPnl: 1870,
              sourceChartId: "workbench-main",
            },
          },
          {
            tradeId: "trade-2",
            title: `${symbol} short structure break`,
            subtitle: "Countertrend fade",
            statusLabel: "Closed on structure break",
            fields: [
              { id: "entry", label: "Entry", valueLabel: "Apr 19 10:05 · 18,540.0" },
              { id: "exit", label: "Exit", valueLabel: "Apr 19 13:40 · 18,498.0" },
              { id: "qty", label: "Size", valueLabel: "1 lot · 215m" },
              { id: "pnl", label: "Net P&L", valueLabel: "+840" },
              { id: "source", label: "Source chart", valueLabel: "workbench-main" },
            ],
            locateLabel: "Locate on chart",
            locateIntent: {
              ...
              tradeId: "trade-2",
              symbol,
              entryTime: Date.UTC(2026, 3, 19, 10, 5),
              exitTime: Date.UTC(2026, 3, 19, 13, 40),
              entryPrice: 18540,
              exitPrice: 18498,
              side: "short",
              quantity: 1,
          ...
          {
            tradeId: "trade-3",
            title: `${symbol} long failed retest`,
            subtitle: "Opening drive retest",
            statusLabel: "Stopped out",
            fields: [
              { id: "entry", label: "Entry", valueLabel: "Apr 22 09:50 · 18,466.0" },
              { id: "exit", label: "Exit", valueLabel: "Apr 22 10:25 · 18,431.5" },
              { id: "qty", label: "Size", valueLabel: "2 lots · 35m" },
              { id: "pnl", label: "Net P&L", valueLabel: "-690" },
              { id: "source", label: "Source chart", valueLabel: "workbench-main" },
            ],
            locateLabel: "Locate on chart",
            locateIntent: {
              ...
              tradeId: "trade-3",
              symbol,
              entryTime: Date.UTC(2026, 3, 22, 9, 50),
              exitTime: Date.UTC(2026, 3, 22, 10, 25),
              entryPrice: 18466,
              exitPrice: 18431.5,
              side: "long",
              quantity: 2,
      ...
      },
      {
        ...
        runMetrics: [
          ...
          { id: "parameter-risk", label: "Risk / Trade", valueLabel: "0.50%" },
          { id: "parameter-session", label: "Session", valueLabel: "ETH" },
        ],
        summaryMetrics: [
          {
            id: "net-profit",
          ...
          },
          {
            ...
            label: "Win Rate",
            valueLabel: "61%",
            detailLabel: "24 / 39 closed trades",
            tone: "positive",
          },
          {
            id: "profit-factor",
            label: "Profit Factor",
            valueLabel: "1.42",
            detailLabel: "Reduced overnight exposure",
            tone: "neutral",
          },
        ],
        filterOptions: [
          { id: "all", label: "All trades", badgeLabel: "3" },
          { id: "winners", label: "Winners", badgeLabel: "2", tradeIds: ["trade-18-1", "trade-18-3"] },
          { id: "losers", label: "Losers", badgeLabel: "1", tradeIds: ["trade-18-2"] },
          { id: "long", label: "Long", badgeLabel: "2", tradeIds: ["trade-18-1", "trade-18-3"] },
          { id: "short", label: "Short", badgeLabel: "1", tradeIds: ["trade-18-2"] },
        ],
        activeFilterId: "all",
        trades: run18Trades,
        tradeDetails: [
          {
            tradeId: "trade-18-1",
            title: `${symbol} long trend continuation`,
            subtitle: "Morning expansion",
            statusLabel: "Closed into trend extension",
            fields: [
              { id: "entry", label: "Entry", valueLabel: "Apr 25 09:40 · 18,510.5" },
              { id: "exit", label: "Exit", valueLabel: "Apr 25 12:05 · 18,622.0" },
              { id: "qty", label: "Size", valueLabel: "1 lot · 145m" },
              { id: "pnl", label: "Net P&L", valueLabel: "+1,115" },
              { id: "source", label: "Source chart", valueLabel: "workbench-main" },
            ],
            locateLabel: "Locate on chart",
            locateIntent: {
              ...
              tradeId: "trade-18-1",
              symbol,
              entryTime: Date.UTC(2026, 3, 25, 9, 40),
              exitTime: Date.UTC(2026, 3, 25, 12, 5),
              entryPrice: 18510.5,
              exitPrice: 18622,
              side: "long",
              quantity: 1,
          ...
          {
            tradeId: "trade-18-2",
            title: `${symbol} short squeeze failure`,
            subtitle: "Late-morning reversal",
            statusLabel: "Stopped on squeeze",
            fields: [
              { id: "entry", label: "Entry", valueLabel: "Apr 26 10:15 · 18,640.0" },
              { id: "exit", label: "Exit", valueLabel: "Apr 26 11:25 · 18,671.5" },
              { id: "qty", label: "Size", valueLabel: "1 lot · 70m" },
              { id: "pnl", label: "Net P&L", valueLabel: "-315" },
              { id: "source", label: "Source chart", valueLabel: "workbench-main" },
            ],
            locateLabel: "Locate on chart",
            locateIntent: {
              ...
              tradeId: "trade-18-2",
              symbol,
              entryTime: Date.UTC(2026, 3, 26, 10, 15),
              exitTime: Date.UTC(2026, 3, 26, 11, 25),
              entryPrice: 18640,
              exitPrice: 18671.5,
              side: "short",
              quantity: 1,
          ...
          {
            tradeId: "trade-18-3",
            title: `${symbol} long range escape`,
            subtitle: "Afternoon continuation",
            statusLabel: "Closed at measured move",
            fields: [
              { id: "entry", label: "Entry", valueLabel: "Apr 28 13:05 · 18,702.0" },
              { id: "exit", label: "Exit", valueLabel: "Apr 28 14:55 · 18,798.0" },
              { id: "qty", label: "Size", valueLabel: "2 lots · 110m" },
              { id: "pnl", label: "Net P&L", valueLabel: "+1,920" },
              { id: "source", label: "Source chart", valueLabel: "workbench-main" },
            ],
            locateLabel: "Locate on chart",
            locateIntent: {
              ...
              tradeId: "trade-18-3",
              symbol,
              entryTime: Date.UTC(2026, 3, 28, 13, 5),
              exitTime: Date.UTC(2026, 3, 28, 14, 55),
              entryPrice: 18702,
              exitPrice: 18798,
              side: "long",
              quantity: 2,
        ...
        equityCurve: [
          { id: "eq-18-1", timeLabel: "Apr 24", equityLabel: "100,000", value: 100000 },
          { id: "eq-18-2", timeLabel: "Apr 25", equityLabel: "101,115", value: 101115, tradeId: "trade-18-1", active: true },
          { id: "eq-18-3", timeLabel: "Apr 26", equityLabel: "100,800", value: 100800, tradeId: "trade-18-2", drawdownLabel: "-315" },
          { id: "eq-18-4", timeLabel: "Apr 28", equityLabel: "102,720", value: 102720, tradeId: "trade-18-3" },
        ],
      },
    ],
    activeRunOptionId: "run-17",
    summaryMetrics: [
      {
        id: "net-profit",
        label: "Net Profit",
