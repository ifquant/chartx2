...
const boundarySummary: EngineBoundarySummary = {
  publicSurface: [
    ...
    "createChartxPhaseOneChart exposes a narrow chart API with pane handles, pane options, chart-level pane events with pane snapshots and stable series metadata, pane resize subscriptions, explicit pane targets, one primary slot, and basic secondary-pane series routing",
  ],
  internalLayers: [
    "typings/helpers",
