...
const boundarySummary: EngineBoundarySummary = {
  publicSurface: [
    ...
    "createChartxPhaseOneChart exposes a narrow chart API with pane handles, pane options, chart-level pane events, pane resize subscriptions, explicit pane targets, one primary slot, and basic secondary-pane series routing",
  ],
  internalLayers: [
    "typings/helpers",
