  ...
  <section class="chart-stage">
    ...
    <div class="chart-copy">
      ...
      <ul>
        ...
        <li>Public pane handles with add/remove, pane sizing, resize subscriptions, chart-level pane events with pane/series metadata snapshots, resizable options, and explicit series-to-pane targeting</li>
