...
import type { PaneFrame, PlotRow, TimePointIndex } from "../../src/lib/chartx/internal/model";
import { buildRawReadout } from "../../src/lib/chartx/internal/views/chart-readout";
